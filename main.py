...
with col1:
    ...
    query = st.text_area("Enter the facts of your legal situation here:", height=200)
    #check the spelling of the query
with col2:
    #insert three radio butons labeled 5 10 and 15
    top_k = st.radio("How many results do you want?", [5, 10, 15])
...
if search_button and query:
    ...
    error_notice = st.write("Please enter the facts of your legal situation and click the search button.")